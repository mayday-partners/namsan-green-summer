...
> 2026 남산 그린 서머 페스티벌 정적 사이트의 이미지 슬롯 인벤토리와 export 규약.
...
| `preview-funwalk` | `/` | 21:9 / 16:9 | 1280·1920·2560 | 좌측 50% 어두운 그라데이션 + 텍스트. 우측에 메인. |
| `preview-night` | `/` | 21:9 / 16:9 | 1280·1920·2560 | 우측 50% 어두운 그라데이션 + 텍스트. 좌측에 메인. |
| `preview-garden` | `/` | 21:9 / 16:9 | 1280·1920·2560 | 좌측 50% 어두운 그라데이션 + 텍스트. 우측에 메인. |
